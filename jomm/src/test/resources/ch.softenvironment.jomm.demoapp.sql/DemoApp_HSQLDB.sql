...
-- Target: 	HSQLDB 1.8.2 (or higher)
-- Depends:	JOMM/sql/NLS_Schema_HSQLDB.sql
-- ***************************************************************
...
CREATE
INDEX T_Ix_RoleProject ON Role (T_Id_Project);
ALTER TABLE Role
...
CREATE SEQUENCE T_Key_Activity START WITH 1;
CREATE SEQUENCE T_Key_Person START WITH 1;
CREATE SEQUENCE T_Key_Project START WITH 1;
CREATE SEQUENCE T_Key_WorkProduct START WITH 1;
CREATE SEQUENCE T_Key_Role START WITH 1;
