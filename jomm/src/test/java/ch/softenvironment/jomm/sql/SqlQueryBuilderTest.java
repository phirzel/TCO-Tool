...
public class SqlQueryBuilderTest {
	...
	public void insertSelect() {
		Long nlsId = 1000L;
		DbQueryBuilder builder = server.createQueryBuilder(DbQueryBuilder.INSERT, "Dummy into T_NLS");
		...
		assertEquals("1 record in T_NLS", 1, ((Number) server.getFirstValue(builder)).longValue());
	}
}
