...
public class ClassA_1 extends DbEntityBean {
  ...
  public static DbDescriptor createDescriptor() {
    ...
    descriptor.addAssociationAttributed(DbDescriptor.AGGREGATION, "bId", new DbMultiplicityRange(0, DbMultiplicityRange.UNBOUND), new DbMultiplicityRange(0, DbMultiplicityRange.UNBOUND), A2b_1.class,
        "aId");
    return descriptor;
  }
}
