...
CREATE SEQUENCE T_Key_T_NLS START WITH 1;

-- !!!PATCH => because the following returns "null": SELECT NEXT VALUE FOR mySequence FROM SYSTEM_SEQUENCES
CREATE TABLE DUAL
(
    DUMMY VARCHAR
);
