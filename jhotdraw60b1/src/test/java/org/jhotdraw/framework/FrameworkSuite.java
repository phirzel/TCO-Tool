...
// JUnitDoclet end extends_implements
{
	...
	public static TestSuite suite() {
		...
		suite = new TestSuite("org.jhotdraw.framework");

		suite.addTestSuite(FigureAttributeConstantTest.class);
		suite.addTestSuite(FigureChangeEventTest.class);
		suite.addTestSuite(DrawingChangeEventTest.class);
