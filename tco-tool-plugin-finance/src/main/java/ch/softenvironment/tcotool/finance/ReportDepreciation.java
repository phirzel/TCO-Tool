...
class ReportDepreciation extends ReportTool {
     ...
     */
    public static ReportTool createBlockDepreciation(ModelUtility utility, TcoObject root, long maxDepreciation, ClassLoader loader) throws Exception {
        ReportDepreciation tool = new ReportDepreciation(utility, ResourceManager.getResource(SEPlugin.class, "MniReportFinancialTotal_text", loader));
        tool.loader = loader;
    ...
    protected void encodeCodes(DbObjectServer server, TcoObject root) throws Exception {
        ...
        encodeDepreciation(root, ResourceManager.getResource(SEPlugin.class, "CTLinearDepreciation", loader));
        ...
        encodeDepreciation(root, ResourceManager.getResource(SEPlugin.class, "CTLinearDepreciationCompoundInterest", loader));
        calculator = new CalculatorDegressiveDepreciation(LauncherView.getInstance().getUtility(), root, maxDepreciation);
        encodeDepreciation(root, ResourceManager.getResource(SEPlugin.class, "CTDegressiveDepreciation", loader));
    }
     ...
     */) throws IOException {
        ...
        // type);
        bold(title);
        simpleContent(" " + ResourceManager.getResource(SEPlugin.class, "CQFactCostIncluded", loader) + ":" /*
        ...
        tmp = "; " + ResourceManager.getResourceAsNonLabeled(SystemParameterDetailView.class, "LblDepreciationInterestRate_text") + " = "
